...
const About = () => {
    return (
        <section className='about'>
            ...
            <p className='about__text'>Glenn is an Attorney from Tampa, Florida. Throughout his life, he has travelled all across this country and in 2015, he decided he wanted to <span className='emphasis'>go anywhere</span>. 
